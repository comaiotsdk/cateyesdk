package com.bumptech.comaiot_glide.module;
 ...
 * {@link com.bumptech.comaiot_glide.GlideBuilder} and registering
 * {@link com.bumptech.comaiot_glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, com.bumptech.comaiot_glide.load.ResourceDecoder)} for each
 * {@link com.bumptech.comaiot_glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
