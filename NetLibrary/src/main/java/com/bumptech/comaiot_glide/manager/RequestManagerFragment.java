package com.bumptech.comaiot_glide.manager;
 ...
 * com.bumptech.comaiot_glide.RequestManager} that can be used to start, stop and manage Glide requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see com.bumptech.comaiot_glide.manager.SupportRequestManagerFragment
 * @see com.bumptech.comaiot_glide.manager.RequestManagerRetriever
 * @see com.bumptech.comaiot_glide.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link com.bumptech.comaiot_glide.RequestManager}.
   *
  ...
  /**
   * Returns the current {@link com.bumptech.comaiot_glide.RequestManager} or null if none exists.
   */
  @Nullable
