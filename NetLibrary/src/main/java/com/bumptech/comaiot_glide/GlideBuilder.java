...
import com.bumptech.comaiot_glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.bumptech.comaiot_glide.load.engine.bitmap_recycle.LruArrayPool;
import com.bumptech.comaiot_glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.bumptech.comaiot_glide.load.engine.cache.DiskCache;
import com.bumptech.comaiot_glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.bumptech.comaiot_glide.load.engine.cache.LruResourceCache;
import com.bumptech.comaiot_glide.load.engine.cache.MemoryCache;
import com.bumptech.comaiot_glide.load.engine.cache.MemorySizeCalculator;
import com.bumptech.comaiot_glide.load.engine.executor.GlideExecutor;
import com.bumptech.comaiot_glide.manager.ConnectivityMonitorFactory;
import com.bumptech.comaiot_glide.manager.DefaultConnectivityMonitorFactory;
import com.bumptech.comaiot_glide.manager.RequestManagerRetriever;
import com.bumptech.comaiot_glide.manager.RequestManagerRetriever.RequestManagerFactory;
...
public final class GlideBuilder {
   ...
   * {@link com.bumptech.comaiot_glide.load.engine.Resource}s that are not currently in use.
   *
   ...
   * com.bumptech.comaiot_glide.load.engine.Resource} data on disk.
   *
   ...
   * {@link com.bumptech.comaiot_glide.load.engine.Resource}s that are not already in the cache.
   *
  ...
  /**
   * Sets the {@link GlideExecutor} to use when retrieving
   * {@link com.bumptech.comaiot_glide.load.engine.Resource}s that are currently in Glide's disk caches.
   *
   ...
   * of {@link com.bumptech.comaiot_glide.load.resource.gif.GifDrawable}s.
   *
   ...
   * {@link com.bumptech.comaiot_glide.load.resource.gif.GifDrawable} or
   ...
   * to use to notify {@link com.bumptech.comaiot_glide.RequestManager} of connectivity events.
