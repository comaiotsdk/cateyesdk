 ...
 * to the previous instance and either call {@link com.bumptech.comaiot_glide.RequestManager#clear(Target)}
 * on the old instance before starting a new load or you must re-use the old instance for the new
 * load. Glide's {@link com.bumptech.comaiot_glide.RequestBuilder#into(Target)} method returns the {@link
 ...
 * calling {@link com.bumptech.comaiot_glide.RequestManager#clear(Target)} and you should always null out
