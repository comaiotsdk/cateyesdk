...
public interface RequestListener<R> {
   ...
   * use {@link com.bumptech.comaiot_glide.RequestBuilder#error(RequestBuilder)} instead.
   *
   ...
   * Target#onResourceReady(Object, com.bumptech.comaiot_glide.request.transition.Transition)}.
   *
   * <p>For threading guarantees, see the class comment.
   *
