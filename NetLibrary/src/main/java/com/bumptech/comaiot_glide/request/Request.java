...
/**
 * A request that loads a resource for an {@link com.bumptech.comaiot_glide.request.target.Target}.
 */
public interface Request {
   ...
   * {@link com.bumptech.comaiot_glide.request.target.Target}s (for example). Using a similar but different
