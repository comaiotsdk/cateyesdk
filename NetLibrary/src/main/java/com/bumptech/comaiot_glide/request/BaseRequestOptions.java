...
import com.bumptech.comaiot_glide.Priority;
import com.bumptech.comaiot_glide.load.DecodeFormat;
import com.bumptech.comaiot_glide.load.Key;
import com.bumptech.comaiot_glide.load.MultiTransformation;
import com.bumptech.comaiot_glide.load.Option;
...
import com.bumptech.comaiot_glide.load.resource.bitmap.CenterCrop;
import com.bumptech.comaiot_glide.load.resource.bitmap.CenterInside;
import com.bumptech.comaiot_glide.load.resource.bitmap.CircleCrop;
import com.bumptech.comaiot_glide.load.resource.bitmap.DownsampleStrategy;
import com.bumptech.comaiot_glide.load.resource.bitmap.Downsampler;
import com.bumptech.comaiot_glide.load.resource.bitmap.DrawableTransformation;
import com.bumptech.comaiot_glide.load.resource.bitmap.FitCenter;
...
import com.bumptech.comaiot_glide.load.resource.gif.GifDrawableTransformation;
import com.bumptech.comaiot_glide.load.resource.gif.GifOptions;
import com.bumptech.comaiot_glide.signature.EmptySignature;
import com.bumptech.comaiot_glide.util.CachedHashCodeArrayMap;
 ...
 * {@link com.bumptech.comaiot_glide.RequestBuilder}.
 *
...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
  ...
  /**
   * Applies a multiplier to the {@link com.bumptech.comaiot_glide.request.target.Target}'s size before
   ...
   *                       {@link com.bumptech.comaiot_glide.request.target.Target}'s dimensions when
   ...
   * {@link com.bumptech.comaiot_glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.bumptech.comaiot_glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.bumptech.comaiot_glide.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * {@link com.bumptech.comaiot_glide.TransitionOptions#dontTransition()}</p>
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
  @NonNull
