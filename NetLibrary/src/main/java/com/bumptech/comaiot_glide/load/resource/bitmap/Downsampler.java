...
import com.bumptech.comaiot_glide.load.ImageHeaderParser.ImageType;
import com.bumptech.comaiot_glide.load.ImageHeaderParserUtils;
...
import com.bumptech.comaiot_glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
import com.bumptech.comaiot_glide.request.RequestOptions;
import com.bumptech.comaiot_glide.request.target.Target;
import com.bumptech.comaiot_glide.util.LogTime;
...
public final class Downsampler {
  ...
  /**
   * Indicates the {@link com.bumptech.comaiot_glide.load.DecodeFormat} that will be used in conjunction
  ...
  /**
   * Indicates the {@link com.bumptech.comaiot_glide.load.resource.bitmap.DownsampleStrategy} option that
   ...
   * {@link com.bumptech.comaiot_glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
   ...
   * provided  {@link com.bumptech.comaiot_glide.load.resource.bitmap.DownsampleStrategy} option.
   *
