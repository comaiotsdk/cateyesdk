...
public abstract class DiskCacheStrategy {
   ...
   * {@link com.bumptech.comaiot_glide.load.data.DataFetcher} and the
   * {@link com.bumptech.comaiot_glide.load.EncodeStrategy} of the
   * {@link com.bumptech.comaiot_glide.load.ResourceEncoder} (if an
   * {@link com.bumptech.comaiot_glide.load.ResourceEncoder} is available).
   */
   ...
   * com.bumptech.comaiot_glide.load.ResourceEncoder} will use to encode the resource.
   */
