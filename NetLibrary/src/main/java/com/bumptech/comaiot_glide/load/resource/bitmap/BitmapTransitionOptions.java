...
import com.bumptech.comaiot_glide.TransitionOptions;
import com.bumptech.comaiot_glide.request.transition.BitmapTransitionFactory;
import com.bumptech.comaiot_glide.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions extends
   ...
   *
   * @see com.bumptech.comaiot_glide.GenericTransitionOptions#with(TransitionFactory)
   */
  @NonNull
   ...
   * @see com.bumptech.comaiot_glide.request.transition.DrawableCrossFadeFactory.Builder
   */
  @NonNull
