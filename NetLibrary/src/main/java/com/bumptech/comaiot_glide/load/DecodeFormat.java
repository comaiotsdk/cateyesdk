package com.bumptech.comaiot_glide.load;

/**
 * Options for setting the value of {@link android.graphics.Bitmap#getConfig()} for
 * {@link android.graphics.Bitmap}s returned by {@link com.bumptech.comaiot_glide.load.ResourceDecoder}s.
 *
 * <p> Note - In some cases it may not be possible to obey the requested setting, not all
 * {@link com.bumptech.comaiot_glide.load.resource.bitmap.Downsampler}s support setting formats and certain
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link com.bumptech.comaiot_glide.load.ResourceDecoder}.
   ...
   * request, use {@link com.bumptech.comaiot_glide.request.RequestOptions#disallowHardwareConfig()}.
   *
