 ...
 * differ depending on the {@link com.bumptech.comaiot_glide.load.ResourceDecoder} using the strategy and
 ...
 * {@link com.bumptech.comaiot_glide.load.Transformation} either instead or in addition to a
 * {@code DownsampleStrategy}.
 *
 * <p>Some differences between versions of Android and
 * {@link com.bumptech.comaiot_glide.load.ResourceDecoder}s are listed below, but the list is not
