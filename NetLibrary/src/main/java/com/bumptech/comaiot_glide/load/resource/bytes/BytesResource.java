package com.bumptech.comaiot_glide.load.resource.bytes;
...
public class BytesResource implements Resource<byte[]> {
   ...
   * @see com.bumptech.comaiot_glide.load.ResourceEncoder
   * @see com.bumptech.comaiot_glide.load.resource.transcode.ResourceTranscoder
   * @see com.bumptech.comaiot_glide.request.SingleRequest#onResourceReady
   */
  @NonNull
  @Override
