 ...
 * com.bumptech.comaiot_glide.load.model.GlideUrl} objects and then uses the wrapped {@link
 * com.bumptech.comaiot_glide.load.model.ModelLoader} for {@link com.bumptech.comaiot_glide.load.model.GlideUrl}s to
 * load the data.
 */
