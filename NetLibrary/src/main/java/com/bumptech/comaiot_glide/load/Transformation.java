...
public interface Transformation<T> extends Key {
   ...
   * com.bumptech.comaiot_glide.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *                  com.bumptech.comaiot_glide.request.target.Target#SIZE_ORIGINAL} to indicate the
