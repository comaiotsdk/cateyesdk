...
/**
 * For a given {@link com.bumptech.comaiot_glide.load.data.DataFetcher} for a given data class, attempts to
 * fetch the data and then run it through one or more
 * {@link com.bumptech.comaiot_glide.load.engine.DecodePath}s.
 *
