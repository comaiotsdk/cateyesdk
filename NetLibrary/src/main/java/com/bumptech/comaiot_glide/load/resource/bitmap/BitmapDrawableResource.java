...
import com.bumptech.comaiot_glide.load.engine.Initializable;
import com.bumptech.comaiot_glide.load.engine.bitmap_recycle.BitmapPool;
import com.bumptech.comaiot_glide.load.resource.drawable.DrawableResource;
import com.bumptech.comaiot_glide.util.Util;

/**
 * A {@link com.bumptech.comaiot_glide.load.engine.Resource} that wraps an
 * {@link BitmapDrawable}
 *
