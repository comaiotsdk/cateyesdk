...
import com.bumptech.comaiot_glide.request.transition.NoTransition;
import com.bumptech.comaiot_glide.request.transition.TransitionFactory;
import com.bumptech.comaiot_glide.request.transition.ViewAnimationFactory;
import com.bumptech.comaiot_glide.request.transition.ViewPropertyAnimationFactory;
import com.bumptech.comaiot_glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   * {@link com.bumptech.comaiot_glide.request.transition.Transition} for each request started with these
