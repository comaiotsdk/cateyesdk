package com.bumptech.comaiot_glide;
...
import com.bumptech.comaiot_glide.load.DecodeFormat;
import com.bumptech.comaiot_glide.load.ImageHeaderParser;
import com.bumptech.comaiot_glide.load.ResourceDecoder;
import com.bumptech.comaiot_glide.load.data.InputStreamRewinder;
import com.bumptech.comaiot_glide.load.engine.Engine;
import com.bumptech.comaiot_glide.load.engine.bitmap_recycle.ArrayPool;
import com.bumptech.comaiot_glide.load.engine.bitmap_recycle.BitmapPool;
import com.bumptech.comaiot_glide.load.engine.cache.MemoryCache;
import com.bumptech.comaiot_glide.load.engine.prefill.BitmapPreFiller;
import com.bumptech.comaiot_glide.load.engine.prefill.PreFillType;
import com.bumptech.comaiot_glide.load.model.AssetUriLoader;
import com.bumptech.comaiot_glide.load.model.ByteArrayLoader;
import com.bumptech.comaiot_glide.load.model.ByteBufferEncoder;
import com.bumptech.comaiot_glide.load.model.ByteBufferFileLoader;
import com.bumptech.comaiot_glide.load.model.DataUrlLoader;
import com.bumptech.comaiot_glide.load.model.FileLoader;
import com.bumptech.comaiot_glide.load.model.GlideUrl;
import com.bumptech.comaiot_glide.load.model.MediaStoreFileLoader;
import com.bumptech.comaiot_glide.load.model.ResourceLoader;
import com.bumptech.comaiot_glide.load.model.StreamEncoder;
import com.bumptech.comaiot_glide.load.model.StringLoader;
import com.bumptech.comaiot_glide.load.model.UnitModelLoader;
import com.bumptech.comaiot_glide.load.model.UriLoader;
import com.bumptech.comaiot_glide.load.model.UrlUriLoader;
import com.bumptech.comaiot_glide.load.model.stream.HttpGlideUrlLoader;
import com.bumptech.comaiot_glide.load.model.stream.HttpUriLoader;
import com.bumptech.comaiot_glide.load.model.stream.MediaStoreImageThumbLoader;
import com.bumptech.comaiot_glide.load.model.stream.MediaStoreVideoThumbLoader;
import com.bumptech.comaiot_glide.load.model.stream.UrlLoader;
import com.bumptech.comaiot_glide.load.resource.bitmap.BitmapDrawableDecoder;
import com.bumptech.comaiot_glide.load.resource.bitmap.BitmapDrawableEncoder;
import com.bumptech.comaiot_glide.load.resource.bitmap.BitmapEncoder;
import com.bumptech.comaiot_glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.bumptech.comaiot_glide.load.resource.bitmap.DefaultImageHeaderParser;
import com.bumptech.comaiot_glide.load.resource.bitmap.Downsampler;
import com.bumptech.comaiot_glide.load.resource.bitmap.ExifInterfaceImageHeaderParser;
import com.bumptech.comaiot_glide.load.resource.bitmap.ResourceBitmapDecoder;
import com.bumptech.comaiot_glide.load.resource.bitmap.StreamBitmapDecoder;
import com.bumptech.comaiot_glide.load.resource.bitmap.UnitBitmapDecoder;
import com.bumptech.comaiot_glide.load.resource.bitmap.VideoDecoder;
import com.bumptech.comaiot_glide.load.resource.bytes.ByteBufferRewinder;
import com.bumptech.comaiot_glide.load.resource.drawable.ResourceDrawableDecoder;
import com.bumptech.comaiot_glide.load.resource.drawable.UnitDrawableDecoder;
import com.bumptech.comaiot_glide.load.resource.file.FileDecoder;
import com.bumptech.comaiot_glide.load.resource.gif.ByteBufferGifDecoder;
import com.bumptech.comaiot_glide.load.resource.gif.GifDrawable;
import com.bumptech.comaiot_glide.load.resource.gif.GifDrawableEncoder;
import com.bumptech.comaiot_glide.load.resource.gif.GifFrameResourceDecoder;
import com.bumptech.comaiot_glide.load.resource.gif.StreamGifDecoder;
import com.bumptech.comaiot_glide.load.resource.transcode.BitmapBytesTranscoder;
import com.bumptech.comaiot_glide.load.resource.transcode.BitmapDrawableTranscoder;
import com.bumptech.comaiot_glide.load.resource.transcode.DrawableBytesTranscoder;
import com.bumptech.comaiot_glide.load.resource.transcode.GifDrawableBytesTranscoder;
import com.bumptech.comaiot_glide.manager.ConnectivityMonitorFactory;
import com.bumptech.comaiot_glide.manager.RequestManagerRetriever;
import com.bumptech.comaiot_glide.module.ManifestParser;
import com.bumptech.comaiot_glide.request.RequestListener;
import com.bumptech.comaiot_glide.request.RequestOptions;
import com.bumptech.comaiot_glide.request.target.ImageViewTargetFactory;
import com.bumptech.comaiot_glide.request.target.Target;
import com.bumptech.comaiot_glide.util.Preconditions;
import com.bumptech.comaiot_glide.util.Util;
import java.io.File;
 ...
 * {@link com.bumptech.comaiot_glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
  ...
  private static void initializeGlide(@NonNull Context context, @NonNull GlideBuilder builder) {
    ...
    List<com.bumptech.comaiot_glide.module.GlideModule> manifestModules = Collections.emptyList();
    ...
    if (annotationGeneratedModule != null
      ...
      Iterator<com.bumptech.comaiot_glide.module.GlideModule> iterator = manifestModules.iterator();
      while (iterator.hasNext()) {
        com.bumptech.comaiot_glide.module.GlideModule current = iterator.next();
    ...
    if (Log.isLoggable(TAG, Log.DEBUG)) {
      for (com.bumptech.comaiot_glide.module.GlideModule glideModule : manifestModules) {
    ...
    for (com.bumptech.comaiot_glide.module.GlideModule module : manifestModules) {
    ...
    try {
      Class<GeneratedAppGlideModule> clazz =
          (Class<GeneratedAppGlideModule>)
              Class.forName("com.bumptech.comaiot_glide.GeneratedAppGlideModuleImpl");
   ...
   * {@link com.bumptech.comaiot_glide.load.Transformation}s. Use outside of these classes is not generally
   * recommended. </p>
   */
  @NonNull
